      ...
      <main className="h-full flex flex-col justify-center items-center">
        ...
        <div className="h-[21rem] w-[40rem] max-sm:h-[25.5rem] max-sm:w-[23rem] flex flex-wrap flex-row justify-center items-center mt-6 max-sm:mt-3 text-3xl max-sm:text-2xl font-sans">
          <Link href="/pdf-merger">
            <button className="m-5 max-sm:m-3 rounded-xl bg-[#074DA6] dark:bg-[#05336E] hover:bg-[#071fa6] dark:hover:bg-[#04234D] hover:ring hover:ring-[#04114d] dark:hover:ring-[#074DA6] text-gray-200 p-2 h-32 w-40 max-sm:h-[7rem] max-sm:w-[8.5rem]">
              PDF Merger
            </button>
          </Link>
