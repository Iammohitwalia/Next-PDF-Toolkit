...
export default function FilePicker(props: FilePickerProps): ReactElement {
  return (
    <>
      <div className="mt-8 p-12 h-[12rem] w-[55%] max-sm:w-[85%] border-4 border-dashed border-[#074DA6] flex items-center justify-center text-center bg-transparent text-[1.4rem] relative shadow-inner font-[sans-serif]">
        <input
